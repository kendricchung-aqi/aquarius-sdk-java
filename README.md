...
```scala
libraryDependencies += "com.aquaticinformatics" % "aquarius.sdk" % "26.2.2"
```
...
```groovy
compile "com.aquaticinformatics:aquarius.sdk:26.2.2"
```
...
```sh
git clone --branch v26.2.2 https://github.com/AquaticInformatics/aquarius-sdk-java.git
cd aquarius-sdk-java
mvn package
```

The generated JAR file will be at `target/aquarius-sdk-26.2.2.jar`.
